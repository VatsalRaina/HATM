...
def text_to_array_bert(pr_1, pr_2, vocab_file):
...
def get_bert_dist(pr_1, pr_2):
    # Tokenize prompts
    vocab_file = '/home/alta/relevance/vr311/attention-topic-model/core/utilities/bert/uncased_L-12_H-768_A-12/vocab.txt'
    prompts, prompt_lens = text_to_array_bert(pr_1, pr_2, vocab_file)
