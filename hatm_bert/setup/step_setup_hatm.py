...
commandLineParser.add_argument('--n_rhid', type=int, default=384,
                               help='which should be loaded')
commandLineParser.add_argument('--n_phid', type=int, default=384,   # This has been changed from the original hatm.py to make the cirrect dimensions for the bert vectors
                               help='which should be loaded')
